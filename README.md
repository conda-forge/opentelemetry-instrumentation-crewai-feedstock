About opentelemetry-instrumentation-crewai-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-crewai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-crewai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-crewai
# for installing globally
pixi global install opentelemetry-instrumentation-crewai
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-crewai` available on your platform:
...
```
pixi search opentelemetry-instrumentation-crewai --channel conda-forge
```
